...
public class PdfChequeos extends PdfHandler {
    ...
    public void pdf() {
        ...
        if (opcion == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Paragraph title = new Paragraph("Reporte Chequeos", fontTitle);
                ...
                celda = new PdfPCell(new Phrase("Observaciones Chequeo", fontHeader));
                celda.setHorizontalAlignment(Element.ALIGN_CENTER);
                celda.setBackgroundColor(Color.LIGHT_GRAY);
                tb.addCell(celda);
                //Se define la columna Vacuna y sus props
                celda = new PdfPCell(new Phrase("Vacuna", fontHeader));
                celda.setHorizontalAlignment(Element.ALIGN_CENTER);
                celda.setBackgroundColor(Color.LIGHT_GRAY);
                tb.addCell(celda);
                //Se define la columna Veterinario y sus props
                celda = new PdfPCell(new Phrase("Veterinario", fontHeader));
                celda.setHorizontalAlignment(Element.ALIGN_CENTER);
                celda.setBackgroundColor(Color.LIGHT_GRAY);
                tb.addCell(celda);
                //Se define la columna Fecha y sus props
                ...
                for (Chequeo chequeo : GestionChequeo.getInstance().getInfoChequeo().values()) {
                    ...
                    tb.addCell(chequeo.getObservaciones());
                    tb.addCell(GestionVacuna.getInstance().getVacunas().get((String.valueOf(chequeo.getIdVacuna()))).getNombre());
                    tb.addCell(chequeo.getNombreVeterinario());
                    tb.addCell(chequeo.getFecha());
                }
